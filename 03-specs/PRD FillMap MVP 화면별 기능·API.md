...
class: log
status: active
source: "raw/confluence/2026-07-25 PRD FillMap MVP — 화면별 기능·API 명세 (cf-18972709).md, raw/confluence/2026-07-18 PRD FillMap MVP — 화면별 기능·API 명세 (cf-18972709).md, raw/confluence/2026-07-25 PRD FillMap MVP — 화면별 기능·API 명세 (cf-18972709) (1).md"
created: 2026-07-18
updated: 2026-08-09
...
> §4가 핵심: 피그마에 그려졌어도 MVP 미확정인 항목들 — 결정이 선행돼야 화면이 산다. **핫구역은 확정 해소**(7/24 MVP 포함·7/25 상단 셀 진입), 남은 미확정 6항목(AI·미방문 추천·격자 표시명·신고 처리·도감 공개범위·Apple 로그인).
> **(2026-07-25 개편)** 지도 홈: 전체/개인 모드 토글 폐지 → 디폴트 개인 모드 + 상단 셀 4종(핫구역·축제·팝업·코스, 단일 선택 토글). 정본 [[기획확정 지도 홈 개편 상단 셀]].
