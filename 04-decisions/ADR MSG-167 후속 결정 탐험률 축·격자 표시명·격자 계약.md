...
class: decision
status: active
source: "raw/confluence/2026-07-23 MSG-167 후속 결정 — 라벨 저장 위치 Q&A · 탐험률 축 · 격자 표시명 (cf-23035906).md"
created: 2026-07-23
updated: 2026-07-23
...
related: ["[[ADR 격자 행정동 라벨 grids.region_code]]", "[[ADR 격자 표시명 zone]]", "[[개인 도감 화면 확정 UX·API 설계]]", "[[Grid API]]", "[[FillMap API 스펙 통합]]", "[[2026-07-23 기획회의 미션·이벤트 표시 방식]]"]
---
...
4. **다음 작업**: `GET /api/collections/videos?regionCode=` 착수 (항목에 gridId 포함, usergrid 전용 DTO 분화, zones 비의존).
...
## 출처
raw: `raw/confluence/2026-07-23 MSG-167 후속 결정 — 라벨 저장 위치 Q&A · 탐험률 축 · 격자 표시명 (cf-23035906).md`
